...
static int32_t ledBlinker()
{
    ...
    // i2cBus->beginTransmission(QMA6100P_ADDRESS_LOW);

    // err = i2cBus->endTransmission();

    // if (err == 0)
    // {
    //     LOG_INFO("QMA6100P device found at address 0x%x\n", QMA6100P_ADDRESS_LOW);
    //     outputData myData;
    ...
    // else
    // {
    //     LOG_INFO("QMA6100P device not found at address 0x%x\n", QMA6100P_ADDRESS_LOW);
    // }
